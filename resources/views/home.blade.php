...
@section('content')
    ...
    <div class="grid md:grid-cols-6 grid-cols-1">
        <div></div>
        <div class="gid grid-cols-1 md:col-span-2 mt-16 md:mt-32 text-neutral-200">
                    ...
                    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-6">
                                ...
                                <p class="text-base leading-relaxed text-gray-300">
                                    - Fin de la page <a class="underline text-blue-400" href="{{ route('magicien') }}">Magicien</a>
                                </p>
                                <p class="text-base leading-relaxed text-gray-300">
        ...
        <div class="flex flex-col justify-center">
            <a href="{{ route('hdv') }}" class="md:mt-16 flex justify-center mt-24">
                <div class="rounded-lg shadow-xl p-4 w-64 hover:bg-gray-600 border shadow-md bg-gray-700 border-gray-600">
                    ...
                    <div class="text-gray-300 text-md text-center mt-4">Accéder à l'hôtel de vente</div>
                    <div class="text-gray-300 text-md text-center">Access to the auction house</div>
                    <div class="text-gray-300 text-md text-center">Zugang zum Auktionshaus</div>
                </div>
            </a>
            <a href="{{ route('contribution') }}" class="flex justify-center mt-4">
                <div class="rounded-lg shadow-xl p-4 w-64 hover:bg-gray-600 border shadow-md bg-gray-700 border-gray-600">
                    ...
                    <div class="text-gray-300 text-md text-center mt-4">Voir les statistiques de guilde</div>
                    <div class="text-gray-300 text-md text-center">View Guild Stats</div>
                    <div class="text-gray-300 text-md text-center">Gildenstatistik anzeigen</div>
                </div>
            </a>
            <a href="{{ route('membres') }}" class="flex justify-center mt-4">
                <div class="rounded-lg shadow-xl p-4 w-64 hover:bg-gray-600 border shadow-md bg-gray-700 border-gray-600">
                    ...
                    <div class="text-gray-300 text-md text-center mt-4">Membres de la guilde Easis</div>
                    <div class="text-gray-300 text-md text-center">Easis Guild Members</div>
                    <div class="text-gray-300 text-md text-center">Mitglieder der Easis-Gilde</div>
                </div>
            </a>
        </div>
        <div></div>
