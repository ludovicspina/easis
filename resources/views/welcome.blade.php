                    ...
                    @if(Auth::user())
                        <li>
                            <a href="{{ route('cdgArchives') }}"
                               class="block py-2 pr-4 pl-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0 text-gray-200 hover:text-white hover:bg-gray-700 hover:text-white md:hover:bg-transparent">Archives
                                CDG</a>
                        </li>
                    @endif
                    <li>
