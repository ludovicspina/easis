        ...
        @if(Auth::user())
            <div class="mt-8 flex flex-col">
                <div class="flex justify-center">
                    <form action="{{ route('cdgAdd') }}" class="w-auto mt-4" method="POST">
                        @csrf
                ...
                @if(session('status'))
                    <div
                        class="flex p-4 mb-4 m-4 opacity-50 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800"
                        role="alert">
